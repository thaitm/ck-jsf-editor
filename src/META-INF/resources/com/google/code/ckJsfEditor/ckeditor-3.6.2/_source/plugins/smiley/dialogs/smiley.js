...
CKEDITOR.dialog.add( 'smiley', function( editor )
{
	...
	var onClick = function( evt )
	{
         ...
         *
         * Wrap it in getUrl so that it works with jsf resource loading.
         *
         */
		var src = CKEDITOR.getUrl(target.getAttribute( 'cke_src' )),
	...
	for ( i = 0 ; i < size ; i++ )
	{
		...
		html.push(
             ...
             *
             */
						' src="', CKEDITOR.getUrl(CKEDITOR.tools.htmlEncode( config.smiley_path + images[ i ] )), '"',
